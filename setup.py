...
cx_Freeze.setup(
    ...
    options = {"build_exe": {"packages":["tkinter","os"], "include_files":["hack.ico",'tcl86t.dll','tk86t.dll', 'college_images','data','database','attendance_report']}},
    version = "1.0",
    description = "Face Recognition Automatic Attendace System | Developed By Yash",
